#!/usr/bin/env python3
"""This module is for pagination using index range and a Server class."""
...
class Server:
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        """
        Get a page from the dataset based on page and page_size.
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> Dict[str, Any]:
        """
        get a page of data with pagination metadata.
